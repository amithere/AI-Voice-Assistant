...
def QueryModifier(Query):
    ...
    question_words = ["what", "who", "where", "when", "why", "how", "which", "whom", "whose", "can you", "could you", "would you", "is it possible", "are there", "do you know", "have you ever", "has anyone", "has it been"]
